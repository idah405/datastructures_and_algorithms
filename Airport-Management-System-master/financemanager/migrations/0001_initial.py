    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='KES', max_digits=14)),
                ('mpesa', models.CharField(help_text='This is the M-Pesa Code for the transaction', max_length=100)),
                ...
                ('financemanager', models.ForeignKey(help_text='financemanager', null=True, on_delete=django.db.models.deletion.CASCADE, to='financemanager.financemanager')),
            ],
        ),
        migrations.CreateModel(
            name='financemanagerProfile',
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='financemanager.financemanager')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='financemanager.financemanager')),
            ],
            options={
