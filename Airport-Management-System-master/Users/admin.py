...
#from handyman.models import User
...
class UserAdmin(BaseUserAdmin):
    ...
    list_filter = ('is_client', 'is_handyman', 'is_financemanager', 'is_manager')
    ordering = ['username']
    filter_horizontal = []
    ...
    fieldsets = (
        ...
        ('verification',
         {'fields': ('is_verified',)}),
        ('Permissions',
         {'fields': ('is_active', 'is_client', 'is_handyman', 'is_financemanager', 'manager')})
    )
    '''
