...
class User(AbstractUser):
    ...
    is_handyman = models.BooleanField(default=False, help_text="Means user can login to handyman portal")
    is_financemanager = models.BooleanField(default=False, help_text="Means user can login to financemanager portal")
    is_manager = models.BooleanField(default=False, help_text="Means user can login to manager portal")
